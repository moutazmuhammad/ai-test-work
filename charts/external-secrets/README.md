...
External secrets management for Kubernetes cluster where it can retrive secrets from External Secret Manager and helps to create kubernetes secrets.
...
| webhook.certManager.cert.issuerRef | object | `{"group":"cert-manager.io","kind":"Issuer","name":"external-secrets-issuer"}` | For the Certificate created by this chart, setup the issuer. See https://cert-manager.io/docs/reference/api-docs/#cert-manager.io/v1.IssuerSpec |
